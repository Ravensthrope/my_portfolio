...
const Socials = () => {
  return (
    <motion.div
      ...
      className="fixed bottom-0 left-0 right-0 p-4 bg-white/30 dark:bg-gray-800/30 backdrop-blur-lg shadow-lg flex justify-center md:static md:mx-20 md:p-4 md:justify-start md:bg-transparent md:dark:bg-transparent md:backdrop-blur-none dark:text-white"
    >
